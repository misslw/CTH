...
//public class WebAppConfig extends WebMvcConfigurationSupport {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        if (mImagesPath.equals("") || mImagesPath.equals("${resources.static-locations}")) {
        ...
        registry.addResourceHandler("/showResources/**").addResourceLocations(mImagesPath);//自定义映射
